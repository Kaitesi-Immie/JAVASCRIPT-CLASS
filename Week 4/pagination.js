...
function renderTable(page, filteredData = data) {     //filteredData = data is a default parameter: if you don’t pass a filtered list, it uses the full dataset.
